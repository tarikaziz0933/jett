            ...
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="icon"
                                style="background: #f5f5f5; height: 300px; overflow:scroll; cursor:pointer">
                            ...
                            <form action="add_service_post.php" method="POST">
                                <div class="mt-3 pos-lg-relative">
                                    ...
                                    <input type="text" name="service_icon" id="icon_input" class="form-control"
                                ...
                                <div class="mt-3">
                                    ...
                                    <textarea name="decrp" class="form-control"></textarea>
                                </div>
                                <div class="mt-3">
