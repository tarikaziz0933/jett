...
$select_image_content = "SELECT * FROM about_images";
                            ...
                            <table class="table table-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $about_content['descrp']?></td>
                                        <td>
                                            <!-- process---1 -->
                                            <!-- <?php if($about_content['status'] == 1){ ?>
                                            <a href="banner_status.php?id=<?= $about_content['id']?>"
                                            ...
                                            <!-- process---2 -->
                                            <a href="about_status.php?id=<?= $about_content['id']?>"
                                                class="btn btn-<?= ($about_content['status'] == 1) ? 'success':'secondary'?>"><?= ($about_content['status'] == 1? 'Active' : 'Deactive') ?></a>

                                        </td>
                                        <td>
                                            <a href="delete_about.php?id=<?=$about_content['id']?>"
                            ...
                            <table class="table table-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="delete_about_image.php?id=<?=$about_image['id']?>"
                                                class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
