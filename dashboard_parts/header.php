...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            <a href="/jett/dashboard/dashboard.php" class="sl-menu-link">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="/jett/contact_info/add_contact_info.php" class="nav-link">Add Contact
                        Info</a></li>
                <li class="nav-item"><a href="/jett/contact_info/view_contact_info.php" class="nav-link">View Contact
                        Info</a>
                </li>
            </ul>
            <a href="#" class="sl-menu-link">
